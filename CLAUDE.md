...
- [ ] Splash: restaurar animação com nome Reflexo + barra horizontal animada
- [ ] Missões de arquétipo: 2-3 missões simultâneas com progresso X/Y visível
- [ ] Jornada: tela criar seu perfil / onde quer chegar acessível e funcional
- [ ] Resultado: mostrar tempo individual de cada rodada além do score final
- [ ] Rodadas por modo: Partida=7, Alvo=10, Sequência=10, Radar=15 — verificar e corrigir
- [ ] Arquétipos: 6 completos (EXPLORADOR→PILOTO) visíveis em timeline no Perfil
- [ ] Criar CHECKPOINT_1.md e commitar ao terminar este grupo

### GRUPO 2 — Bugs de arquitetura
- [ ] Streak duplicado: remover inline do App.tsx, usar sempre utils/streak.calculateStreak
- [ ] ModoSequencia: círculo some lentamente — corrigir timing do feedback visual
- [ ] Radar nos arquétipos: adicionar como 4º modo em detectArchetypeId e targetCriteria
- [ ] Criar CHECKPOINT_2.md e commitar ao terminar este grupo

### GRUPO 3 — Intro + Onboarding novo (aprovado pelo conselho)
Referência: reflexo-intro-onboard.html

PARTE 1 — Intro (5 telas splash):
- [ ] T1: manter visual atual, mover botão navegação para zona inferior (era no topo — affordance failure)
- [ ] T2: substituir por tela de ciência/dados (por que funciona — antes do como)
- [ ] T3: substituir tela com # quebrado por revelação do arquétipo O Explorador com avatar SVG
- [ ] T4: meta pessoal (copy atual está bom)
- [ ] T5: modos disponíveis (mais compacta)
- [ ] Adicionar botão Pular no top-right em todas as telas
- [ ] Botão de navegação: Próximo → explícito na zona inferior, não gesto de deslize

PARTE 2 — Onboarding oficial (após COMEÇAR — fluxo OB1 a OB4):
- [ ] OB1: mini-jogo de reflexo — 3 toques, sem rodadas, captura primeiro ms do usuário
- [ ] OB2: resultado real com contexto (ex: 284ms — acima da média humana) + lore snippet
- [ ] OB3: revelação do arquétipo baseado na performance real + preview do próximo arquétipo
- [ ] OB4: escolha de meta com 4 opções que personalizam missões da semana
- [ ] Fluxo total: 90-120 segundos, usuário entra na Home com número + identidade + objetivo
- [ ] Criar CHECKPOINT_3.md e commitar ao terminar este grupo
...
- [ ] Home — seguir reflexo-home-v2.html
- [ ] Missões — seguir reflexo-missoes.html
- [ ] Perfil — seguir reflexo-perfil.html com timeline de 6 arquétipos
- [ ] Resultado — seguir reflexo-pos-partida.html com tempos individuais por rodada
- [ ] Gameplays — seguir reflexo-gameplay-redesign.html para abertura dos 4 modos
- [ ] Estados de erro nos 4 gameplays (seguir reflexo-estados-erro.html):
...
- [ ] Criar CHECKPOINT_4.md e commitar ao terminar este grupo

### GRUPO 5 — Animação de arquétipo (prioridade máxima do conselho)
Referência: reflexo-arquetipo-evolucao.html

- [ ] Implementar tela/modal de evolução disparado quando arquétipo muda
- [ ] Frame 1 (60ms): flash branco + Haptics.Heavy
- [ ] Frame 2 (300ms): avatar scale 0→1.05→1 com easing
- [ ] Frame 3 (200ms): nome do arquétipo letra a letra + Haptics.Medium
- [ ] Frame 4 (600ms): partículas explodindo do avatar + Haptics.Success
- [ ] Frame 5 (400ms): contador XP animado
- [ ] Frame 6: CTA Continuar fade in
- [ ] Criar CHECKPOINT_5.md e commitar ao terminar este grupo

### GRUPO 6 — Housekeeping final
- [ ] Substituir emojis restantes por SVG inline
- [ ] Atualizar ROADMAP.md tiscando todos os itens concluídos
- [ ] Atualizar este CLAUDE.md com estado final real
- [ ] Commit final: feat: versão final — design conselho + onboarding + funcionalidades completas
- [ ] Criar VERSAO_FINAL.md com: o que foi implementado, o que ficou pendente, bugs conhecidos, próximos passos recomendados
